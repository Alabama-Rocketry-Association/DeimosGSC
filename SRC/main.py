...
coord = (lat, lon)
weatherData = weather(coord)
l0 = Layout.addLayout(border=(83, 83, 83))

#Ambient temperature
#(0K − 273.15) × 9/5 + 32 = -459.7°F
ambiTemp_F = (weather.ambientTemp - 273.15) * 9/5 + 32
ambiTemp_graph = l0.addPlot(title="Ground Temperature (" + degree_sign + "F)")
ambiTemp_graph.hideAxis('bottom')
ambiTemp_graph.hideAxis('left')
ambiTemp_text = pg.TextItem(str(ambiTemp_F), anchor=(0.5, 0.5), color="w")
ambiTemp_text.setFont(font)
ambiTemp_graph.addItem(ambiTemp_text)
